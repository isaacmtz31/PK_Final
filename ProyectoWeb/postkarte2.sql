...
/*INSERTS NECESARIOS PARA LOS PAPELES Y CATEGORIAS*/
	insert into papel (nombrePapel, img, idCategoria) values ('Papel1','./../imgs/papeles/papel1.jpg',1),
										   ('Papel2','./../imgs/papeles/papel2.jpg',1),
                                           ('Papel3','./../imgs/papeles/papel3.jpg',1),
                                           ('Papel4','./../imgs/papeles/papel4.jpg',1),
                                           ('Papel5','./../imgs/papeles/papel5.jpg',1),
                                           ('Papel6','./../imgs/papeles/papel6.jpg',1),
                                           ('Papel7','./../imgs/papeles/papel7.jpg',1),
                                           ('Papel8','./../imgs/papeles/papel8.jpg',1),
                                           ('Papel9','./../imgs/papeles/papel9.jpg',1),
                                           ('Papel10','./../imgs/papeles/papel10.jpg',1);
...
insert into karte(nombreK,descripcion,idPapel) values ("Feliz Cumpleaños","Feliz Cumpleaños","1");
select * from relUsuarioKarte;

-- Delete from usuario where idUsuario =1;
select * from usuario;

update usuario set nombreUsuario = "arturo",apellidoUsuario = "garcia",contra = "1234",email = "luis@mail.com",genero = "masculino",edad = 21 where idUsuario = 2;

insert into relUsuarioKarte(idRemitente,idDestinatario,idKarte) values(1,2,1);