<?php
      ...
      $papelName = "";
      try {
          if(isset($_GET['IM']) && !empty($_GET['IM']))
            {
              $myImg = "./../imgs/papeles/" . $_REQUEST["IM"];
              $papelName = $_REQUEST["IM"];
            }
          else
                 ...
                 <div class="" >
                    <div class="row">
                      <div class="col s12 l6 m12" >
                        <h5><i>Tu imagen</i></h5>
                          <img id="imgPostal"  class="materialboxed responsive-img" src="<?php echo $myImg; ?>"><br><br>
                          <a href="./Explorar"><h5><i>Explorar más imagenes </i></h5></a>
                      </div><br><br>
                      <form id="enviarPostal" class="col s12 l6 m12" id="" autocomplete="on">
                        <div class="row">
                          <h5>Datos para tu PostKarte</h5>
                          <div class="input-field center-align col s12 m8 l8">
                            <input id="nombrePK" name="nombrePK" type="text" class="validate" data-validetta="required,minLength[5],maxLength[20]">
                            <label for="nombrePK">Nombre de tu <i>PostKarte</i></label>
                            <span class="helper-text" data-error="wrong" data-success="right">¡Elige un nombre original!</span>
                            <br><br>
                          </div>
                          <div class="input-field col s12">
                            <input id="emailD" name="emailD" type="email" class="validate" data-validetta="required,email">
                            <label for="emailD">E-mail del <i>destinatario</i></label>
                            <span class="helper-text" data-error="wrong" data-success="right">Es nesario que ingreses un correo válido, de lo contrario, la postal no llegará a su destino.</span><br><br>
                          </div>

                          <div class="input-field col s12">
                            <textarea id="descrip" name="descrip" class="materialize-textarea" data-length="120" data-validetta="required, maxLength[120]"></textarea>
                            <label for="descrip">Dedicatoria especial</label>
                        ...
                        <input id="hide" name="hide" type="hidden" name="hide" value="<?php echo $papelName; ?>">
                      </form>
                    </div>
                 </div><!-- /container -->
               </div>
