                    ...
                    <div class="row">
                      ...
                      <form id="enviarPostal" class="col s12 l6 m12" id="" autocomplete="on">
                        <div class="row">
                          ...
                          <div class="input-field col s12">
                            <textarea id="textarea2" class="materialize-textarea" data-length="120" data-validetta="required, maxLength[120]"></textarea>
                        ...
                        <input id="hide" name="hide" type="hidden" name="" value="<?php echo $myImg; ?>">
                      </form>
                    </div>
                 </div><!-- /container -->
               </div>
